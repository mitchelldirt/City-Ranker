        ...
        <>
            <div className='scoresContainer'>
                <div className='scoreContainer'>
                    <img alt={'Walking Icon for walk score'.concat(cityID)} src='/walk.svg' />
                    <Pie percentage={walkScore} colour="blue" />
                </div>

                <div className='scoreContainer'>
                    <img alt={'Biking Icon for bike score'.concat(cityID)} src='/bike.svg' />
                    <Pie percentage={bikeScore} colour="blue" />
                </div>

                <div className='scoreContainer'>
                    <img alt={'Train Icon for transit score'.concat(cityID)} src='/train.svg' />
